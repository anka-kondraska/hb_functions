...
def hello_world():
    """Function that prints Hello World because 
...
def say_hi(name):
    """Function that prints Hi and your name"""
...
def print_product(int1, int2):
    """Function that prints a product of two integeres"""
...
def repeat_string(string_to_print, this_many_times):
    """Function that prints a string this many times"""

    print string_to_print * this_many_times
...
def print_sign(int1):
    """Function that evalutes if your int1 is above, lower or is zero"""
...
def is_divisible_by_three(int1):
    """Function which determines if your int is divisible by 3"""
...
def num_spaces(sentence):
    """Function that counts number of spaces in a sentence"""
...
def total_meal_price(meal_price, tip_percent=0.15):
    """Function that calculates total to pay for a meal with 15% tip as default"""

    total_paid = meal_price + meal_price * tip_percent
    return total_paid
...
def sign_and_parity(int1):
    """Function that evaluest int to Negavtive or POsitive, Even or Odd"""
...
def full_title(name, job_title="Engineer"):
    """Function that returns full title and name"""

    return job_title + " " + name

def write_letter(name, job_title, sender_name):
    """Function that prints a letter inclusive of job title, name and sender"""
